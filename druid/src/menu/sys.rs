...
pub mod common {
    ...
    pub fn redo<T: Data>() -> MenuItem<T> {
        ...
        #[cfg(not(feature = "l10n"))]
        let item = MenuItem::new("Redo").command(commands::REDO);
...
pub mod win {
    ...
    pub mod file {
        ...
        pub fn default<T: Data>() -> Menu<T> {
            #[cfg(feature = "l10n")]
            let m = Menu::new(LocalizedString::new("common-menu-file-menu"));
            #[cfg(not(feature = "l10n"))]
            let m = Menu::new("File");
            m.entry(new())
                .entry(open())
        ...
        pub fn close<T: Data>() -> MenuItem<T> {
            ...
            #[cfg(not(feature = "l10n"))]
            {
                MenuItem::new("Close").command(commands::CLOSE_WINDOW)
            }
        }
        ...
        pub fn print_preview<T: Data>() -> MenuItem<T> {
            ...
            #[cfg(not(feature = "l10n"))]
            {
                MenuItem::new("Print Preview").command(commands::PRINT_PREVIEW)
            }
        }
        ...
        pub fn page_setup<T: Data>() -> MenuItem<T> {
            ...
            #[cfg(not(feature = "l10n"))]
            {
                MenuItem::new("Page Setup...").command(commands::PRINT_SETUP)
            }
        }
        ...
        pub fn exit<T: Data>() -> MenuItem<T> {
            ...
            #[cfg(not(feature = "l10n"))]
            {
                MenuItem::new("Exit").command(commands::QUIT_APP)
            }
        }
    }
}
...
pub mod mac {
    ...
    pub mod application {
        ...
        pub fn default<T: Data>() -> Menu<T> {
            ...
            {
                #[cfg(feature = "l10n")]
                let m = Menu::new(LocalizedString::new("macos-menu-application-menu"));
                #[cfg(not(feature = "l10n"))]
                let m = Menu::new("Application");
                m.entry(about())
                    .separator()
        ...
        pub fn about<T: Data>() -> MenuItem<T> {
            ...
            #[cfg(not(feature = "l10n"))]
            {
                MenuItem::new("About App").command(commands::SHOW_ABOUT)
            }
        }
        ...
        pub fn show_all<T: Data>() -> MenuItem<T> {
            ...
            #[cfg(not(feature = "l10n"))]
            {
                MenuItem::new("Show All").command(commands::SHOW_ALL)
            }
        }
